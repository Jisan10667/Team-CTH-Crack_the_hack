...
public class FreeTake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FirestoreRecyclerAdapter<Free , FreeTake.FreeProductViewHolder>(options) {
            @NonNull
            @Override
            public FreeTake.FreeProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                // view base on layout free item xml
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.free_item , parent,false);
                return new FreeTake.FreeProductViewHolder(view);
            }

            @Override
            // what to get from database
            protected void onBindViewHolder(@NonNull FreeTake.FreeProductViewHolder holder, int position, @NonNull Free model) {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(FreeTake.this, Menu.class);
