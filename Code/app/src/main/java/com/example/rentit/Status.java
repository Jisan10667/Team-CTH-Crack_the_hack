...
public class Status extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirestoreRecyclerOptions<UserTrack> options = new FirestoreRecyclerOptions.Builder<UserTrack>()
                .setQuery(query, UserTrack.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<UserTrack, Status.StatusProductViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull Status.StatusProductViewHolder holder, int position, @NonNull UserTrack model) {
