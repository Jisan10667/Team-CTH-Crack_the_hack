...
public class RentGive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_give);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                insertData();
                Intent intent = new Intent(RentGive.this , Menu.class );
        ...
        firebaseFirestore.collection("Products").add(items)
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        pd.dismiss();
                        Toast.makeText(RentGive.this,"Post Successful", Toast.LENGTH_SHORT).show();
                    }
                });
        // adding to  Product database
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == IMAGE_REQ && resultCode == RESULT_OK)
        {
            ...
            Glide.with(RentGive.this).load(imageUri).into(img);
            // loading  img to IMage view
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    ...
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            test = uri;
                            pd.dismiss();
                            Toast.makeText(RentGive.this,"Image Upload Successful", Toast.LENGTH_SHORT).show();
                            // upload done confirmation
