...
public class FreeGive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_give);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                insertData();
                Intent intent = new Intent(FreeGive.this , Menu.class );
        ...
        firebaseFirestore.collection("Free").add(items)
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(FreeGive.this,"Post Successful", Toast.LENGTH_SHORT).show();
                    }
                });
        // adding to Free Product database
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == IMAGE_REQ && resultCode == RESULT_OK)
        {
            ...
            Glide.with(FreeGive.this).load(imageUri).into(img);
            // loading  img to IMage view
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    ...
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            test = uri;
                            pd.dismiss();
                            Toast.makeText(FreeGive.this,"Image Upload Successful", Toast.LENGTH_SHORT).show();
                            // upload done confirmation
