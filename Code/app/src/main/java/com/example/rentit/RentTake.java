...
public class RentTake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_take);// Initializing variable
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(RentTake.this, Menu.class);
